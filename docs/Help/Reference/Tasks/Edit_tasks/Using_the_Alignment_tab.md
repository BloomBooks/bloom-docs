...
4.  Click the end of the **Change Layout** [control](About_the_Change_Layout_controls.md) to _hide_ the controls.
...
-   The vertical alignment you choose do _not_ affect the alignment in [ePUB files](../../Concepts/EPUB.md).
