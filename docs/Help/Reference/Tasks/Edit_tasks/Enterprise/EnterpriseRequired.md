...
-   An Enterprise Required message box will appear in the Publish tab if you have one or more books that use Canvas Tool elements. It will not appear if you are translating a [shell book](../../../Concepts/Shell_book.md) with Canvas Tool elements.
