...
2.  Look at the right side of the Bloom window and then do these steps:
    ...
    -   If you do _not_ see the ![](/ref-docs-assets/images/Tasks/Edit_tasks/Impairment_Visualizer/ImpairmentVisualizerBrownIcon.png) **Impairment Visualizer** tab, click the **More** tab.  
