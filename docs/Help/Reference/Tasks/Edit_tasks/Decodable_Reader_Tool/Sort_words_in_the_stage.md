...
-   ![](/ref-docs-assets/images/Tasks/Edit_tasks/Decodable_Reader_Tool/SortByFrequency.png) **Sort by frequency** (_not_ available for [Allowed words](Allowed_Words_Files.md)).
