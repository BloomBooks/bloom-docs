...
1.  In the _left_ pane, click **Add Stage**.
...
1.  In the _left_ pane, click the stage you want to configure.
    
2.  In the _right_ pane, do these steps:
    
    -   In the **New Sight Words** box, type or paste [sight words](../../../Concepts/Sight_words.md) that you want to introduce in _this_ stage. Separate the words with spaces.
...
1.  In the _left_ pane, click and drag the stage you want to move. Release the mouse button when it is in the desired order.
...
1.  In the _left_ pane, click the stage you want to remove.
