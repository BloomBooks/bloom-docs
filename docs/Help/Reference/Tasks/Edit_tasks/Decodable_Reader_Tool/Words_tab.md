...
In this box, type words that you want Bloom to suggest. These words are _in addition to_ [sight words](../../../Concepts/Sight_words.md) and to words in the [files](../../../Concepts/About_word_lists_and_sample_texts.md).
