...
2.  Look at the right side of the Bloom window and then do these steps:
    ...
    -   If you do _not_ see the ![](/ref-docs-assets/images/Tasks/Edit_tasks/Image_Description_Tool/ImageDescriptionTool_Brown.png) **Image Description Tool** tab, click the **More** tab.  
