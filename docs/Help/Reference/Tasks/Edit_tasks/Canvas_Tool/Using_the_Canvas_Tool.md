...
-   ![PICTURE](/ref-docs-assets/images/Tasks/Edit_tasks/Canvas_Tool/CropImage%20Canvas.png) (Crop) does not change the actual image, but only changed what you see. This is different from the Crop ![PICTURE](/ref-docs-assets/images/Crop.png) feature in the [Image Toolbox](../../../User_Interface/Dialog_boxes/Image_Toolbox.md).
