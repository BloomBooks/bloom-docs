...
[Bloom callout boxes](../../Concepts/Callout_box.md) and [source text](../../Concepts/Source_text.md) boxes can appear on many of the pages in your books. For [inside pages](../../Concepts/Inside_pages.md), you can add additional words or sentences to them. Or, if callout boxes do not appear in your book, you can type words or sentences to appear as _hint bubbles_. These are to provide helpful information intended for the translator.
...
6.  Click the end of the **Change Layout** [control](About_the_Change_Layout_controls.md) to _hide_ the controls.
...
-   Unlike setting a [style](../../Concepts/Styles.md), this property is for the current text box _only_. It will persist if you use **Duplicate Page**. However, if you change it later in one of the pages, it will not change in any other pages.
    
-   These texts boxes are _not_ the same as those you can add when you [use](Canvas_Tool/Using_the_Canvas_Tool.md) the **Canvas Tool**.
