...
2.  Look at the right side of the Bloom window and then do these steps:
    ...
    -   If you do _not_ see the ![](/ref-docs-assets/images/Tasks/Edit_tasks/Sign_Language_Tool/VideoPlaceHolderSMALL.png) **Sign Language Tool** tab, click the **More** tab. Then select (![](/ref-docs-assets/images/CheckedBoxMorePane.png)) **Sign Language Tool**.
