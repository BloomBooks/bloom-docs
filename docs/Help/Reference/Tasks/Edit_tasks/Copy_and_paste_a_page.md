...
[Duplicate Page](Duplicate_a_page.md) copies and immediately pastes a page into the _same_ [book](../../Concepts/Book.md).
...
Do these steps _after_ you are done [formatting](../../User_Interface/Dialog_boxes/Format_dialog_box.md), [using](Using_the_Change_Layout_controls.md) **Change Layout** control and [working with](../../User_Interface/Dialog_boxes/Format_dialog_box.md) [styles](../../Concepts/Styles.md).

1.  Click ![](/ref-docs-assets/images/User_Interface/Tabs/Collections.png) **Collections** [tab](../../User_Interface/Tabs/Tabs_overview.md).
    
2.  In the _left_ pane, click the book that has the page you want to copy. Then, do one of these steps:
...
6.  In the _left_ pane, click the book into which you want to paste the page. Then do one of these steps:
