...
When your mouse pointer is over a playback order button, a _minus_ sign (![](/ref-docs-assets/images/Tasks/Edit_tasks/Record_Audio/ReduceOrder.png)), a _plus_ sign (![](/ref-docs-assets/images/Tasks/Edit_tasks/Record_Audio/IncreaseOrder.png)) or both is displayed.

2.  Set the order:
    
    -   For the words you want to hear _first_, click the minus sign until you see the number **1**.
        
    -   For the words you want to hear _second,_ click the minus sign until you see the number **2**.
        
    -   Continue until each location where there is text shows the desired playback order number.
        
    -   If you changed the playback order of the image description, it will typically play _after_ the other text boxes and **Canvas** **Tool** element.
