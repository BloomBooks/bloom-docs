...
4.  Click ![](/ref-docs-assets/images/Tasks/Edit_tasks/Record_Audio/CheckableAudio.png) **4) Check** to listen to that recording.
    ...
    -   If you are _not_ satisfied with the recording, click and hold the **Speak** button again and read that text again.
        
    
    ![](/ref-docs-assets/images/Tasks/Edit_tasks/Record_Audio/ClearButton.png) **Clear** is an _optional_ way to delete the recording for the current text.
