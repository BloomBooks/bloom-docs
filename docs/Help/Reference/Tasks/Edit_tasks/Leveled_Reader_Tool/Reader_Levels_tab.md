...
1.  In the _left_ pane, click **Add Level**.
...
1.  In the _left_ pane, click the level you want to configure.
    
2.  In the _right_ pane, select (![](/ref-docs-assets/images/CheckedBox.PNG)) the [criteria](About_Count_and_Length_criteria.md) you want to display in the **Leveled Reader Tool**.  
...
1.  In the _left_ pane, click and drag the level you want to move. Release the mouse button when it is in the desired order.
