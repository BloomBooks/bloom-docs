...
You [review](Review_Count_and_Length_information.md) **Word Counts**, **Word Lengths** and **Sentence Counts** in the ![](/ref-docs-assets/images/Tasks/Edit_tasks/Leveled_Reader_Tool/Leveled_Reader_Tool_icon.png) **Leveled Reader Tool**. These include **Max** (Maximum) numbers and **Actual** numbers for the _current_ level. Some are for the current page and others for the current book. Some are averages.
