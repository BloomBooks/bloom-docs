...
**Duplicate Page** copies and immediately pastes a page into the _same_ book.

Do these steps _after_ you are done [formatting](../../User_Interface/Dialog_boxes/Format_dialog_box.md), [using](Using_the_Change_Layout_controls.md) **Change Layout** control and [working](../../User_Interface/Dialog_boxes/Format_dialog_box.md) with [styles](../../Concepts/Styles.md).
...
2.  In the _left_ pane, click the book.
...
-   If the button or the commands are _not_ available, you cannot duplicate the current page. Typically, you can duplicate pages that you [added](Add_a_page.md).
