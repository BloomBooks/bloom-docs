...
_Accessibility_ is a measure of how well people who are visually impaired can consume the contents of a book (or website and so on). **See Also:** [About Book Features](Features.md).
...
Select (![pic](/ref-docs-assets/images/Tasks/Publish_tasks/SelectedCheckBoxGreen.png)) this check box to make an [ePUB](../../Concepts/EPUB.md) in which the [image descriptions](../Edit_tasks/Image_Description_Tool/Image_Description_Tool_overview.md) actually _appear_ on the pages.
...
-   **Accessibility Checker**
    ...
    2.  [Use](Use_Bloom_Accessibility_Checker_dialog_box.md) this dialog box to make sure your book is _accessible_ to the visually impaired _before_ you [publish](Digital_publishing_options.md) it.
