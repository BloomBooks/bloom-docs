...
-   In the most common case, the book is laid out as a collection of A5 pages, two of which are printed side by side on an A4 page. The printer should be set to print A4 pages in landscape mode, using options to _print on both sides of paper_ and _flip on short edge_ (or _short edge binding)._ Your printer driver might calls this arrangement something else.
