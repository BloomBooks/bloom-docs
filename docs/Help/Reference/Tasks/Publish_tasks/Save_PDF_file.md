...
2.  Edit the file name (_optional_).
    

Do _not_ change type of file. The filename extension needs to be **.pdf**.
...
-   PDF files are automatically compressed using _Ghostscript_ ([https://www.ghostscript.com/](https://www.ghostscript.com/ "https://www.ghostscript.com/")).
