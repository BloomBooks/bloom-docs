...
7.  In the **Save As** dialog box, navigate to the folder where you want to save the file.
    ...
    -   Edit the file name (_optional_). Do not change type of file. It needs to be \***.epub**.
...
-   _Dropbox_ and similar services are a handy way to move your Bloom ePUB files to your phone.
