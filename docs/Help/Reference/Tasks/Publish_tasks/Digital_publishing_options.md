...
-   ![](/ref-docs-assets/images/Tasks/Publish_tasks/Android_Button_New.png)**BloomPUB** — This option allows you and others to view your books on phone apps (_Bloom Reader_ and _Reading App Builder_ apps) and on Windows using _BloomPUB Viewer_.
...
_Dropbox_ is one handy way to copy your ePUB files to your device (e.g. phone). Save the ePUB file to your **Dropbox** folder. On your phone, open the **Dropbox** app and select your book.

_Google Drive_ and _Microsoft's One Drive_ are other services you should consider.

_SHAREit_ is a cross platform app for sharing data.
...
-   ![](/ref-docs-assets/images/Tasks/Publish_tasks/PDFandPrint.png) **PDF & Print** is _not_ actually a digital publishing option, but you can [save](Save_PDF_file.md) your book as a \*.pdf file.
