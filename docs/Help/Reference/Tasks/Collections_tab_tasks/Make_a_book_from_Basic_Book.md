...
Here, the steps are for the **Basic Book** template, but the steps for _[other](Collections_tab_tasks_overview.md)_ available [templates](../../Concepts/Template.md) are similar. **See Also:** [Is this an update of your existing book?](../../User_Interface/Dialog_boxes/Is_this_an_update_of_your_existing_book.md)
