...
2.  In the _left_ pane, below **Sources For New Books**, click the **Wall Calendar** [template](../../Concepts/Template.md).
...
The **Pages** (_left_) pane shows the pages of the calendar.
