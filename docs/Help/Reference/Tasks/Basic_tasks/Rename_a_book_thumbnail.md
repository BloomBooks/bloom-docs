...
The thumbnail name (_and_ the names of the files where Bloom stores the book) change. The book title, shown on the [front cover](../../Concepts/Front_Cover_page.md) and [title](../../Concepts/Book_Title.md) pages, does not change.
