...
-   When you do this task, you may want to [open](../Open_a_collection.md) a book in the [collection](../../../Concepts/Collection.md) where it was created (where it was an _original_ book).
