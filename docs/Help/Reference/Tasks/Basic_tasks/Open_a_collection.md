...
4.  If you do _not_ see the collection, click ![](/ref-docs-assets/images/Tasks/browse4lib.png) **Browse for another collection on this computer**.
...
-   In the ![](/ref-docs-assets/images/BloomIcon_red.gif) **Open/Create Collections** dialog box, hold your mouse pointer over the name of a collection to see its path. Then, if you _browse_ for another collection, its folder might be nearby.
