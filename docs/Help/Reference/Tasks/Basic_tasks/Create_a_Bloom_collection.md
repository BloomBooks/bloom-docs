...
-   _Dialects_ of a particular language can be handled as separate collections.
    

In the **Create New Bloom Collection** dialog box, choose the main language for the collection and then type the name of _a dialect_ in the box with this label:
