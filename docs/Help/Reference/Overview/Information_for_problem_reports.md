...
-   Reports you send via email to issues@bloomlibrary.org are added to our bug-tracking site. Anyone with an account can read your report.
    ...
    If you send a report by email, _instead of_ using the **Report A Problem** [dialog box](../User_Interface/Dialog_boxes/Report_A_Problem_dialog_box.md), please include the following:
    

-   Tell us the _version_ of the Bloom program that you are using.  
