...
-   \*.jpg format is only suitable for photographs, but _not_ for line art.
    
-   The pictures from _Art of Reading_ are typically \*.png.
...
-   If you convert a _line art_ picture to \*.jpg, it will cause errors that you can see as a noticeable reduction in quality.
...
Picture conversion happens if you use **Save As** and choose a _different_ format for the picture file.
