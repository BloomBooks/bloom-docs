...
1.  If the Work _cannot_ be modified by the receiver the following license applies:
    ...
    -   You must share this Work using the same by-_nc-nd_ license.
...
2.  If the Work _can_ be modified by the receiver, the following license applies:
    ...
    -   You must share newly created Works using the same by-_nc-sa_ license.
...
-   **PUBLIC Note:** Content or data distributed from the use of the SIL Pathway tool requires acknowledgement of compliance with your organization’s Intellectual Property (such as, copyright) and Archiving policies. _A copyright statement and license must be included in the publicly shared form of the data_.
