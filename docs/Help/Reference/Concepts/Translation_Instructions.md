...
-   The page has a text box that is "language indifferent" or "language agnostic" (_not_ specific to any language in the collection).
...
-   It is _excluded_ from all published files ([Bloom Reader](Bloom_Reader_App.md), [PDF](../Tasks/Publish_tasks/Save_PDF_file.md), and so on).
