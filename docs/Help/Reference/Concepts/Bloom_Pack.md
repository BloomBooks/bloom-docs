...
One person can [create shell books for others](../Tasks/Shell_book_tasks/Create_a_shell_book.md) and then [make](../Tasks/Shell_book_tasks/Make_a_Bloom_Pack.md) a Bloom Pack that other people can [get](../Tasks/Basic_tasks/Get_shell_books_from_others.md). People who get these Bloom Packs can translate the book into other languages. However, the **Template Pages** page is _not_ available for use, nor can the pages be reordered.
...
-   Bloom does the same things as it does for a basic Bloom Pack but _also_ puts the decodable reader settings, the leveled reader settings, and the current set of [sample words](../Tasks/Edit_tasks/Decodable_Reader_Tool/Words_tab.md) in the file.
    
-   Files in the Sample Texts folder become _.json_ files. **See:** [About word list and sample texts](About_word_lists_and_sample_texts.md).
