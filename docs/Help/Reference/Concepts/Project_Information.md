...
-   [Enter](../Tasks/Basic_tasks/Enter_project_information.md) this data for each [collection](Collection.md) you have. It is _not_ passed between computers in [Bloom Packs](Bloom_Pack.md).
