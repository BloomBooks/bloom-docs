...
| **Ctrl**+A | Select All (all the content in the current box or page) |
| **Ctrl**+B | Bold text |
| **Ctrl**+C | Copy selected text to clipboard |
| **Ctrl**+I | Italic text |
| **Ctrl**+L | Left-align |
| **Ctrl**+N | [Add a page](../../Tasks/Edit_tasks/Add_a_page.md) |
| **Ctrl**+R | Right-align |
| **Ctrl**+U | Underline text |
| **Ctrl**+V _or_ **Shift**+**Insert** | Paste text from clipboard to location of cursor (insertion point). The text is pasted as plain text, without bold, italics and so on. |
| **Ctrl**+X | Cut selected text from text box to clipboard |
| **Ctrl**+Z<br/>**Ctrl**+**Y** | Undo - reverse the most recent _typed_ change.<br/>Redo - reverse most recent **Undo** operation. |
| **Tab** or **Shift**+**Tab** | If a page has two text boxes:<br/>• **Tab** moves forward to second text box<br/>• Shift+Tab moves back to first text box. |
| **Ctrl**+Spacebar | Clears **Ctrl**+B, **Ctrl**+U and **Ctrl**+I. |
| Paste text with \\v | Example:<br/>If you copy and paste \\v123, you will see 123 (superscript). |
...
| **Ctrl**+Minus | Zoom out |
| **Ctrl**+Plus | Zoom in |
| Shift+**Ctrl**+N | Go to specific page |
