...
-   **Local Language**
    ...
    This is the language of the intended readers of _monolingual_ books. It is the primary language in [multilingual](../../Concepts/Bilingual_or_trilingual_books.md) books.
