...
-   Click the link that appears, either **Set up metadata** _or_ **Edit**.
...
If the program is unable to modify the file (CD, directory or drive for which you do _not_ have write permission, and so on), it will appear to work normally, but the metadata will _not_ be there the next time you select that image.
