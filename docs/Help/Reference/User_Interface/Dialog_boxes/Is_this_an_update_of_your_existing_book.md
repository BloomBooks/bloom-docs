...
If you copied the book folder _manually_ in your computer file explorer and edited the copy, the original and copy will have the same book ID. To prevent that, use [Duplicate (copy) a book](../../Tasks/Basic_tasks/Duplicate_a_book.md) and this Bloom feature will provide a different book ID for the copy of the book.
