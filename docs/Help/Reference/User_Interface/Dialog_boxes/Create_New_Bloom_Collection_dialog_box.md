...
In the **Create New Bloom Collection** dialog box, choose the main language for the collection. Then, type the name of _a dialect_ in the box that has this label:
