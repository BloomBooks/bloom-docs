...
-   On the _left_ side, you see labels like **Sign Language**, **Basic Book**, **Arithmetic**, and **Game Pages** and so on.
...
-   Some pages are _not_ shown if they are used with [experimental features](Settings_dialog_box.md) but **Show Experimental Features** is _not_ selected.
