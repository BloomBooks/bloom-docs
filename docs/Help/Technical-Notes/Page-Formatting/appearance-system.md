...
2. Use the new “Book Settings” UI to choose a theme and set a small number of other properties, such as margins.
3. Create a customBookStyles.css file that uses the new properties. For this, see [Create Appearance-compatible custom CSS and Themes](/appearance-system-css).
