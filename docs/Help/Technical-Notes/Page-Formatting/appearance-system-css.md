...
| --image-border-radius                                        |                                                                                                                                                                                                                                          |                                                                                                                                                | _border-radius_ for images added by the user to the front cover or to a content page [https://developer.mozilla.org/en-US/docs/Web/CSS/border-radius](https://developer.mozilla.org/en-US/docs/Web/CSS/border-radius))                                                                                                                                                                                                                                           | 6.0                      |                     |
| --marginBox-background-color                                 |                                                                                                                                                                                                                                          |                                                                                                                                                | background-color for the visible page surface inside the page margins, including behind text boxes, between text boxes, behind partially transparent pictures, and between text boxes and pictures. In flat themes this normally follows --page-background-color. Prior to Bloom 6.4, `--marginBox-background-color` was set to white with a dark `--page-background-color` in order to create a visual frame (for rounded border theme). In 6.4 we introduced an explicit `--page-frame-color`. [default is var(--page-background-color)] | 6.0                      |                     |
...
| --page-background-color                                      |                                                                                                                                                                                                                                          |                                                                                                                                                | background-color for the visible page surface. In flat themes this colors the whole page. In framed themes it colors the reading surface inside the frame. [default is white]                                                                                                                                                                                                                                                                                                                                                              | 6.0                      | 6.4                 |
| --page-frame-color                                           |                                                                                                                                                                                                                                          |                                                                                                                                                | background-color for the outer .bloom-page shell when a theme wants a decorative surround behind the page surface. Leave this unset for flat themes so the shell falls back to --page-background-color. [default is unset]                                                                                                                                                                                                                                                                                                                 | 6.4                      |                     |
...
| --pageNumber-color                                           |                                                                                                                                                                                                                                          |                                                                                                                                                | color for displaying the page number text. [default is black]                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | 6.0                      |                     |
| --pageNumber-outline-color                                   |                                                                                                                                                                                                                                          |                                                                                                                                                | outline color for displaying the page number text. Use this when the number needs more contrast against the page or image. [default is theme-dependent]                                                                                                                                                                                                                                                                                                                                                                                    | 6.0                      |                     |
| --pageNumber-background-color                                |                                                                                                                                                                                                                                          |                                                                                                                                                | background-color for displaying the page number. [default is transparent]                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | 6.0                      |                     |
