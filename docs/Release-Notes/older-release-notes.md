...
- [Decodable Reader](about:blank#decodable-reader) If you change the letters of a stage then close the dialog by clicking “OK”, the toolbox tool doesn’t update to show the new letters
- [Decodable Reader](about:blank#decodable-reader) If a letter is in a letter combination in current the stage, DR should not automatically allow its constituent letters
