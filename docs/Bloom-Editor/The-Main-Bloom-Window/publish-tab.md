...
4. **ePUB**: ePUB is a widely used digital publishing format, but it cannot reliably present some Bloom book features.
	...
	For a comparison between the BloomPUB and ePUB formats see [BloomPUB vs. ePUB: What’s the Difference](https://app.notion.com/d6f626a5bcc746b78eb0e9d9a1e5e699). 
