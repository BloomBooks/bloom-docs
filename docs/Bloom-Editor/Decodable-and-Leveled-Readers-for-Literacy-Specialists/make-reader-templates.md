---
title: Make your Reader Templates
sidebar_position: 4
slug: /make-reader-templates
...
2. Click **Decodable Reader**.
	...
	![](./make-reader-templates.32e4bb19-df12-80ee-a6b1-ed6de1800262.png)

3. In the right pane, you see a button that looks like this: .

	![](./make-reader-templates.32e4bb19-df12-80e1-ba84-dc653074991c.png)
...
5. Let’s make sure the book is set Stage 2. Here is how you do it:
	- In the **Decodable Reader Tool** pane, find the stage control:
		...
		![](./make-reader-templates.32e4bb19-df12-80f8-a263-e24e09249ab2.png)
...
![](./make-reader-templates.32e4bb19-df12-8090-9159-cf882b499991.png)
...
3. Each text box has a small gray “gear” control: It is at the lower left corner of the box: . Click that gear control. It looks like this:
	...
	![](./make-reader-templates.32e4bb19-df12-8000-8cfd-f10b7c62d1ab.png)
...
![](./make-reader-templates.33b4bb19-df12-809e-804b-f8045153d508.png)
...
![](./make-reader-templates.33b4bb19-df12-8089-a3e1-f8355512d1ea.png)
...
1. Click the  **Collections** tab.
	...
	![](./make-reader-templates.32e4bb19-df12-8057-a9d0-d49335beab2d.png)

2. In the Sources for New Book, click **Leveled Reader**.

	![](./make-reader-templates.32e4bb19-df12-80c0-a1cf-c9b49e57f872.png)
...
1. In the upper right, click on the Setting Icon:
	...
	![](./make-reader-templates.32e4bb19-df12-80c7-87c1-d173fa0e644b.png)
...
![](./make-reader-templates.33b4bb19-df12-8049-b60a-ef3c949d3924.png)
